...
## The Solution
{{<figure src="/img/configuration-screen-1.png" class="center" style="max-width 995px;" alt="Zellij configuration screen showing the Change Mode Behavior option with Unlock-First (non-colliding) preset">}}
...
{{<figure src="/img/configuration-screen-2.png" class="center" style="max-width 995px;" alt="Zellij configuration screen showing keybinding rebind options for unlock toggle and secondary modifier">}}
